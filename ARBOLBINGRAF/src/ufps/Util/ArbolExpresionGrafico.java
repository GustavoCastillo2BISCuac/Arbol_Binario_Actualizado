...
import javax.swing.*;
/**@author ANDRES*/
public class ArbolExpresionGrafico <G> extends JPanel{
    private Arbol1 miArbol;
    ...
    public ArbolExpresionGrafico(Arbol1<G> miArbol) 
    {
    ...
    private void calcularPosiciones() 
    {
         posicionNodos.clear();
         subtreeSizes.clear();
         NodoG<G> root = this.miArbol.getRaiz();
         if (root != null) 
         {
    ...
    private Dimension calcularTamañoSubarbol(NodoG<G> n){
          if (n == null) 
    ...
    private void calcularPosicion(NodoG<G>n, int left, int right, int top) 
    {
      if (n == null) 
          return;
    ...
    private void dibujarArbol(Graphics2D g, NodoG<G>n, int puntox, int puntoy, int yoffs) 
    {
     if (n == null) 
         return;
